    ...
    <footer className='bg-white rounded-lg shadow dark:bg-gray-900'>
      <div className='w-full max-w-screen-xl mx-auto p-4 md:py-8'>
        <div className='sm:flex sm:items-center sm:justify-between'>
          ...
          >
            <img width={170} height={230} src={Logo} alt='EncryptShare Logo' />
          </Link>
              ...
              <NavLink
                ...
                className={(isActiveObj) =>
                  isActiveObj.isActive
                    ? "hover:underline me-4 md:me-6 text-xl max-sm:text-base text-blue-800 font-bold"
                    : "hover:underline me-4 md:me-6 text-xl max-sm:text-base"
                }
              >
                Home
              </NavLink>
